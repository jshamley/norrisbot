...
NorrisBot.prototype._welcomeMessage = function() {
    this.postMessageToChannel('general', 'Hi guys, roundhouse-kick anyone?' +
        '\n I can tell jokes, but very honest ones. Just say `Chuck Norris` to invoke me!',
        {as_user: true}, function(data) {
            console.log(data)
        });
}
